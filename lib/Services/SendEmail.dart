          ...
          child: Center(
            child: MaterialButton(
              ...
              onPressed: (){
                ...
                sendEmail("ayushpratiksrivastava@gmail.com","Test","ORDER#1111","Your order has been placed","Hi Ayush, we're getting your order ready to be shipped. We will notify you when it has been sent.<br><br>Thanks,<br>YA CAB.");
              },
            ),
          ),
        )
...
async {
  String imagePath="https://firebasestorage.googleapis.com/v0/b/YA CAB-fa718.appspot.com/o/logo%20and%20others%2FLogo.jpeg?alt=media&token=e2bd50c4-6c4a-4d06-b8d1-267822b902a3";
  body+="<br><I>If you have any query then kindly reply to this email or contact us at support@yacab.in</I>";
...
async {
  ...
  final smtpServer = SmtpServer(domainSmtp,username: username,password: password,port: 465,ssl: true);
  //YA CABisp@gmail.com
  final message = Message()
