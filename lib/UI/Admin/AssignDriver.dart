...
class _AssignDriverState extends State<AssignDriver> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                builder: (context,snapshot){
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context,index){
                        String status=drivers[index]['status']=="True"?"Approved"
                            :drivers[index]['status']=="False"?"Disapproved"
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                Flexible(
                                                  child: Text("Name : ${drivers[index]['name']} ",
                                                    style: TextStyle(
                                                      fontSize: 20,
                                                      fontWeight: FontWeight.w900,
                                                ...
                                                IconButton(onPressed: (){
                                                  ...
                                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>DriversAccount(driver_id: drivers[index]['driver_id'],name: drivers[index]['name'],)));
                                                  ...
                                                  child: Align(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: MaterialButton(
                                                          ...
                                                          onPressed: () {
                                                            if(drivers[index]['latitude']!=null)
                                                            MapsLauncher.launchCoordinates(drivers[index]['latitude'],drivers[index]['longitude'],drivers[index]['name']);
                                                          },
                                                          child:Padding(
                                                            padding: const EdgeInsets.all(8.0),
                                                            child: FittedBox(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor:  HexColor("#35B736"),
        onPressed: (){
          assignDriver();
        },
        child: Padding(
  ...
  void assignDriver(){
    firRef.child("Bookings").orderByChild("booking_id").equalTo(widget.booking_id).once().then((DatabaseEvent datasnapshot) {
      try {
