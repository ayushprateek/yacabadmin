  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              //     }
                  return ListView.builder(
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>EditBanner(
                            title: "Home Banner",
                            banner_id: banners[index]['banner_id'],
                          )));
                        },
                          child: banners[index]['status']=="True"?image:Center(
                            child: Stack(
                              children: [
                                //lists[index].image
                                Container(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: HexColor("#4CD864"),
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddBanners()));
        },
