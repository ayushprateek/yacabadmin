  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(height: 50,),
              StreamBuilder(
                stream: firRef.child("Categories").orderByChild("parent_id").equalTo(widget.category_id).onValue,
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>EditRates(category_id: categories[index]['category_id'],name: categories[index]['name'],)));
                              },
                              child: Column(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddRates(parent_id: widget.category_id,)));
        },
