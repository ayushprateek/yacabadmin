  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                ...
                                showAnimatedDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return ClassicGeneralDialogWidget(
                                      ...
                                      onPositiveClick: () {
                                        Navigator.pop(context);
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Rates(category_id: categories[index]['category_id'],name: categories[index]['name'],)));
                                      },
                                    );
                                  },
                                );
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddCategory(parent_id: widget.category_id,)));
        },
