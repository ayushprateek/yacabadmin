...
class EditCustomer extends StatefulWidget {
  ...
  EditCustomer({required this.customer_id, required this.name});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.name == null ? "Customer's Account" : widget.name,
          style: TextStyle(
              ...
              StreamBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  if (!isSet) {
                    ...
                    Status =
                        customer[0]['status'] == "True" ? "Active" : "Inactive";
                  }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Customer ID : " + customer[0]['customer_id'],
                              style: new TextStyle(
