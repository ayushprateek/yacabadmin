...
class FitnessCertificate extends StatefulWidget {
  String driver_id;
  FitnessCertificate({
  required this.driver_id
  });
  @override
  _FitnessCertificateState createState() => _FitnessCertificateState();
}
class _FitnessCertificateState extends State<FitnessCertificate> {
  File? _imageFile;
  String? fileName;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
              stream: firRef.child("FitnessCertificate").orderByChild("driver_id").equalTo(widget.driver_id).onValue,
  ...
  void update(BuildContext context)
  {
    ...
    firRef.child("FitnessCertificate")
      ...
      try {
        ...
        values.forEach((key, value) {
          firRef.child("FitnessCertificate").child(key.toString()).update({
            "image":fileName,
            "status":Status,
