...
class Insurance extends StatefulWidget {
  ...
  Insurance({required this.driver_id});
...
class _InsuranceState extends State<Insurance> {
  ...
  void add(BuildContext context) {
    firRef
      ...
      try {
        ...
        firRef.child("Insurance").child(newKey.toString()).set({
          "image": fileName,
  ...
  void update(BuildContext context) {
    firRef
      ...
      Fluttertoast.showToast(msg: 'Insurance updated to $Status');
...
//     if(values!=null)
//       values.forEach((key, value) {
//         firRef.child("Insurance").child(key.toString()).update({
//           "image":fileName,
//           "status":Status,
//           "date_updated":DateTime.now().toIso8601String(),
//           "reason":Status=="Disapproved"?reason.text:null,
