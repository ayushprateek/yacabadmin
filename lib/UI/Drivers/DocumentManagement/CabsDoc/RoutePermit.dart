...
class RoutePermit extends StatefulWidget {
  String driver_id;

  RoutePermit({required this.driver_id});

  @override
  _RoutePermitState createState() => _RoutePermitState();
}

class _RoutePermitState extends State<RoutePermit> {
  ...
  void add(BuildContext context) {
    firRef
      ...
      try {
        ...
        firRef.child("RoutePermit").child(newKey.toString()).set({
          "image": fileName,
  ...
  void update(BuildContext context) {
    firRef
      ...
      Fluttertoast.showToast(msg: 'RoutePermit updated to $Status');
...
//     if(values!=null)
//       values.forEach((key, value) {
//         firRef.child("RoutePermit").child(key.toString()).update({
//           "image":fileName,
//           "status":Status,
//           "date_updated":DateTime.now().toIso8601String(),
//           "reason":Status=="Disapproved"?reason.text:null,
