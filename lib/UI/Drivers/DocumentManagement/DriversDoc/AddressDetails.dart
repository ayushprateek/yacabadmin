...
class AddressDetails extends StatefulWidget {
  ...
  AddressDetails({required this.driver_id});
...
class _AddressDetailsState extends State<AddressDetails> {
  ...
  void add(BuildContext context) {
    firRef
      ...
      try {
        ...
        firRef.child("AddressDetails").child(newKey.toString()).set({
          "image": fileName,
  ...
  void update(BuildContext context) {
    firRef
      ...
      Fluttertoast.showToast(msg: 'AddressDetails updated to $Status');
...
//     if(values!=null)
//       values.forEach((key, value) {
//         firRef.child("AddressDetails").child(key.toString()).update({
//           "image":fileName,
//           "status":Status,
//           "date_updated":DateTime.now().toIso8601String(),
//           "reason":Status=="Disapproved"?reason.text:null,
