...
class BankDetails extends StatefulWidget {
  ...
  BankDetails({required this.driver_id});
...
class _BankDetailsState extends State<BankDetails> {
  ...
  void add(BuildContext context) {
    firRef
      ...
      try {
        ...
        firRef.child("BankDetails").child(newKey.toString()).set({
          "image": fileName,
  ...
  void update(BuildContext context) {
    firRef
      ...
      Fluttertoast.showToast(msg: 'BankDetails updated to $Status');
...
//     if(values!=null)
//       values.forEach((key, value) {
//         firRef.child("BankDetails").child(key.toString()).update({
//           "image":fileName,
//           "status":Status,
//           "date_updated":DateTime.now().toIso8601String(),
//           "reason":Status=="Disapproved"?reason.text:null,
