...
class DrivingLiscense extends StatefulWidget {
  String driver_id;
  DrivingLiscense({
    required this.driver_id
});
  @override
  _DrivingLiscenseState createState() => _DrivingLiscenseState();
}
class _DrivingLiscenseState extends State<DrivingLiscense> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
              stream: firRef.child("DrivingLiscense").orderByChild("driver_id").equalTo(widget.driver_id).onValue,
