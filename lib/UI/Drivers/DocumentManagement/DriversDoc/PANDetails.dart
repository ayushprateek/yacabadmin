    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
              stream: firRef.child("PANDetails").orderByChild("driver_id").equalTo(widget.driver_id).onValue,
