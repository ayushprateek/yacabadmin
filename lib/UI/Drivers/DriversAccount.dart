        ...
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(height: 50,),
              StreamBuilder(
                stream: firRef.child("Drivers").orderByChild("driver_id").equalTo(widget.driver_id).onValue,
                  ...
                  if(driver.length!=0)
                    return ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          String status=driver[index]['status']=="True"?"Approved"
                              :driver[index]['status']=="False"?"Disapproved"
                              :driver[index]['status'];
                          ...
                          return InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>EditDriver(driver_id: widget.driver_id, name: widget.name,)));
                            },
                            child: Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                              ...
                                              mainAxisAlignment: MainAxisAlignment.start,
                                              children: [
                                                Text("Name : ${driver[index]['name']}",
                                                  style: TextStyle(
                                                    fontSize: 20,
                                                    fontWeight: FontWeight.w900,

                                                  ),),
                                                Text("Driver ID : ${driver[index]['driver_id']} ",
                                                  style: TextStyle(
                                                    fontSize: 15,
                                                    fontWeight: FontWeight.w900,
                                      ...
                                      InkWell(
                                        onTap: (){
                                          customLaunchURL("tel:+91${driver[index]['mobile']}");
                                        },
                                        child: Text(
                                          "${driver[index]['mobile']}",
                                          style: TextStyle(
                                          ...
                                          Align(
                                            ...
                                            child: Container(
                                              ...
                                              child: MaterialButton(
                                                  ...
                                                  onPressed: () {
                                                    if(driver[index]['latitude']!=null)
                                                      MapsLauncher.launchCoordinates(driver[index]['latitude'],driver[index]['longitude'],driver[index]['name']);
                                                  },
                                                  child:Padding(
                                      ...
                                      Container(
                                        ...
                                        child: MaterialButton(
                                            ...
                                            onPressed: () {
                                              Navigator.push(context, MaterialPageRoute(builder: (context)=>AllBookings(id: widget.driver_id,keyName:  "driver_id",)));
                                            },
                                            child:Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: Text("View bookings of this driver",
                                                style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 20
                                                ),),
              ...
              Container(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Vehicle(driver_id: widget.driver_id,)));
                    },
                    child:Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("View driver's vehicle",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 20
                        ),),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>FitnessCertificate(driver_id: widget.driver_id,)));
                        },
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>Insurance(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "Insurance",
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>LeasePaper(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "Lease Paper",
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>PollutionCertificate(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>RoutePermit(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "Route Permit",
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddressDetails(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "Address Details",
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>AdhaarDetails(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "Adhaar Details",
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>BankDetails(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "Bank Details",
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>DrivingLiscense(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "Driving Liscense",
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>PANDetails(driver_id: widget.driver_id,)));
                        },
                        leading: Icon(Icons.image,size: 50,color: Colors.grey,),
                        title: Text(
                          "PAN Details",
