...
class _EditDriverState extends State<EditDriver> {
                  ...
                  if(driverImage.length!=0)
                    return ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          String status=driverImage[index]['status']=="True"?"Approved"
                              :driverImage[index]['status']=="False"?"Disapproved"
                    ...
                    return Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            SizedBox(height: 15,),
                            Text("Driver ID : "+driver[0]['driver_id'],
                              style: new TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w900
                              ),),
                            ...
                            SizedBox(height: 10,),
                            driver[0]['status'].toString().toUpperCase()=="DISAPPROVED" &&
                            ...
                            Align(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(width: 10,),
                                  Flexible(
                                    child: Text(driver[0]['reason'].toString().toUpperCase(),
                                      style: TextStyle(
                                          color: Colors.black,
  ...
  void update(BuildContext context){
    firRef.child("Drivers").orderByChild("driver_id").equalTo(widget.driver_id).once().then((DatabaseEvent datasnapshot) {
      try {
