...
class Vehicle extends StatefulWidget {
  ...
  Vehicle({required this.driver_id});
                ...
                children: [
                    ...
                    child: TextFormField(
                      ...
                      decoration: new InputDecoration(
                        ...
                        prefixIconConstraints:
                            BoxConstraints(minWidth: 0, minHeight: 15),
                        // Icon(Icons.phone_android, color: Color(0XFF27ab87"),),
                        fillColor: Colors.white,
                        hoverColor: Colors.red,
                        //focusColor:Color(0XFF27ab87"),
                        // isDense: true,
                  ...
                  Status == "Disapproved"
                      ? Align(
                          alignment: Alignment.centerLeft,
                          child: Text(
                            "Reason of Disapproval : " + reason.text,
                            style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.w900,
                                fontSize: 20),
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () {
                        if (brand.text == null || brand.text == "") {
                          ...
                          Fluttertoast.showToast(
                              msg: "Vehicle number cannot be empty");
                        } else if (colour.text == null || brand.text == "") {
                          Fluttertoast.showToast(msg: "Brand cannot be empty");
                        } else if (num_of_seats.text == null ||
                            num_of_seats.text == "") {
                          Fluttertoast.showToast(
                              msg: "Number of Seats cannot be empty");
                        } else {
                          if (update) {
